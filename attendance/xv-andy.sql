...
CREATE TABLE `guests` (
  ...
  `phone_number_guest` varchar(15) DEFAULT NULL,
  `status_guest` varchar(255) NOT NULL DEFAULT 'CONFIRMADO',
...
CREATE TABLE `qr_codes` (
  `id_qr_code` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `link_qr_code` text DEFAULT NULL,
  `adults_qr_code` int(11) DEFAULT NULL,
  `kids_qr_code` int(11) DEFAULT NULL,
